    ...
    int M)
{
    ...
    wmma::fragment<wmma::matrix_a, 16, 16, 16, wmma_half_t, wmma::col_major> a_frag_real[K][4];
    wmma::fragment<wmma::matrix_a, 16, 16, 16, wmma_half_t, wmma::col_major> a_frag_imag[K][4];
    ...
    wmma::fragment<wmma::accumulator, 16, 16, 16, wmma_half_t> acc_frag_real[K];
    ...
    int M)
{
    ...
    if (threadIdx.y < N/16)
    {
        ...
        wmma::fragment<wmma::matrix_a, 16, 16, 16, wmma_half_t, wmma::col_major> a_frag_real[K][2];
        wmma::fragment<wmma::matrix_a, 16, 16, 16, wmma_half_t, wmma::col_major> a_frag_imag[K][2];
        ...
        wmma::fragment<wmma::accumulator, 16, 16, 16, wmma_half_t> acc_frag_real[K][2];
    ...
    int M)
{
    ...
    wmma::fragment<wmma::matrix_a, 16, 16, 16, wmma_half_t, wmma::col_major> a_frag[K][8];
