    ...
    int M)
{
    ...
    wmma::fragment<wmma::matrix_b, 16, 16, 16, wmma_half_t, wmma::row_major> b_frag[K][4];
    ...
    int M)
{
    ...
    wmma::fragment<wmma::matrix_b, 16, 16, 16, wmma_half_t, wmma::row_major> b_frag[K][8];
    ...
    int M)
{
    ...
    if (threadIdx.y < N / 16)
    {
        ...
        wmma::fragment<wmma::matrix_b, 16, 16, 16, wmma_half_t, wmma::row_major> b_frag[K][2];
