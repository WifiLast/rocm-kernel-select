...
#include "kernels_bf16/monarch_cuda_kernel_r2r_bf16.h"
...
#define CHECK_LAST_CUDA_ERROR() checkLastBF16FwdR2R(__FILE__, __LINE__)
void checkLastBF16FwdR2R(const char* const file, const int line)
{
