...
#include "kernels_bf16/monarch_cuda_16_16_16_bwd_complex_kernel_bf16.h"
#include "kernels_bf16/monarch_cuda_32_16_16_bwd_complex_kernel_bf16.h"
#include "kernels_bf16/monarch_cuda_16_32_32_bwd_complex_kernel_bf16.h"
#include "kernels_bf16/monarch_cuda_32_32_32_bwd_complex_kernel_bf16.h"
#if defined(__HIP_PLATFORM_AMD__)
...
#define CHECK_LAST_CUDA_ERROR() checkLastBF16ComplexBwd(__FILE__, __LINE__)
void checkLastBF16ComplexBwd(const char* const file, const int line)
{
...
monarch_conv_bwd_cuda_16_16_16_complex_bf16_all(
  ...
  case 4096:
    ...
    if (B >= 4 && (B % 4) == 0 && (H % 8) == 0) {
      ...
      monarch_conv_bwd_cuda_complex_kernel<32, 4, 4096, 1, 16, false, 4, 8, 4><<<gridDim, blockDim, (4 * fftsize + 4 * 256) * sizeof(half)>>>(
          static_cast<at::BFloat16 *>(dout_real.data_ptr()),
          static_cast<at::BFloat16 *>(dout_imag.data_ptr()),  
          ...
          static_cast<at::BFloat16 *>(dx_out_real.data_ptr()),
          static_cast<at::BFloat16 *>(dx_out_imag.data_ptr()),
      ...
      monarch_conv_bwd_cuda_complex_kernel<32, 4, 4096, 1, 16, false, 2, 8, 4><<<gridDim, blockDim, (4 * fftsize + 4 * 256) * sizeof(half)>>>(
          static_cast<at::BFloat16 *>(dout_real.data_ptr()),
          static_cast<at::BFloat16 *>(dout_imag.data_ptr()),  
          static_cast<at::BFloat16 *>(x_real.data_ptr()),
          static_cast<at::BFloat16 *>(x_imag.data_ptr()),
      ...
      monarch_conv_bwd_cuda_complex_kernel<32, 4, 4096, 1, 16, false, 1, 8, 4><<<gridDim, blockDim, (4 * fftsize + 4 * 256) * sizeof(half)>>>(
          static_cast<at::BFloat16 *>(dout_real.data_ptr()),
          static_cast<at::BFloat16 *>(dout_imag.data_ptr()),  
          static_cast<at::BFloat16 *>(x_real.data_ptr()),
          static_cast<at::BFloat16 *>(x_imag.data_ptr()),
      ...
      monarch_conv_bwd_cuda_complex_kernel<32, 4, 4096, 1, 16, false, 1, 1, 4><<<gridDim, blockDim, (4 * fftsize + 4 * 256) * sizeof(half)>>>(
          static_cast<at::BFloat16 *>(dout_real.data_ptr()),
          static_cast<at::BFloat16 *>(dout_imag.data_ptr()),  
          static_cast<at::BFloat16 *>(x_real.data_ptr()),
          static_cast<at::BFloat16 *>(x_imag.data_ptr()),
  ...
  switch (fftsize) {
    case 16384:
      ...
      if (B >= 8 && (B % 8) == 0 && (H % 8) == 0) {
        ...
        CUDA_RT_CALL(cudaFuncSetAttribute(&monarch_conv_bwd_cuda_16_32_32_complex_kernel<32, 8, 16384, 1, 2, 16, false, 4, 8, 8>, cudaFuncAttributeMaxDynamicSharedMemorySize, 140000));
        
        monarch_conv_bwd_cuda_16_32_32_complex_kernel<32, 8, 16384, 1, 2, 16, false, 4, 8, 8><<<gridDim, blockDim, (4 * fftsize + 4 * 1024) * sizeof(half)>>>(
            static_cast<at::BFloat16 *>(dout_real.data_ptr()),
            static_cast<at::BFloat16 *>(dout_imag.data_ptr()),  
            static_cast<at::BFloat16 *>(x_real.data_ptr()),
            static_cast<at::BFloat16 *>(x_imag.data_ptr()),
