...
#include "kernels_fp16/monarch_cuda_bwd_kernel_r2r.h"
#if defined(__HIP_PLATFORM_AMD__)
...
#define CHECK_LAST_CUDA_ERROR() checkLastFP16BwdR2R(__FILE__, __LINE__)
void checkLastFP16BwdR2R(const char* const file, const int line)
{
