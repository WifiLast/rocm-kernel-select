...
__device__ __forceinline__ void _complex_matmul_truncated(
    ...
    wmma::fragment<wmma::matrix_b, WMMA_M, WMMA_K, WMMA_N, wmma_half_t, BLayout> b_frag[MATMUL_WARP_WIDTH][MATMUL_WARP_WIDTH][2],
   ...
   if (output_to_shmem) {
      ...
      for (int j_b = 0; j_b < MATMUL_WARP_WIDTH/2; j_b++) {
         ...
         for (int j_a = 0; j_a < MATMUL_WARP_WIDTH; j_a++) {
            ...
            wmma::store_matrix_sync(reinterpret_cast<wmma_half_t*>(
               a_real + (out_trans ?
...
__device__ __forceinline__ void complex_matmul_truncated(
    ...
    wmma::fragment<wmma::matrix_b, WMMA_M, WMMA_K, WMMA_N, wmma_half_t, BLayout> b_frag[MATMUL_WARP_WIDTH][MATMUL_WARP_WIDTH][2],
    wmma::fragment<wmma::accumulator, WMMA_M, WMMA_K, WMMA_N, wmma_half_t> acc_frag_1[MATMUL_WARP_WIDTH][MATMUL_WARP_WIDTH][2],
    wmma::fragment<wmma::matrix_a, WMMA_M, WMMA_K, WMMA_N, wmma_half_t, ALayout> k_frag[MATMUL_WARP_WIDTH][MATMUL_WARP_WIDTH][2],
    wmma::layout_t out_layout = wmma::mem_row_major)
{
...
__device__ __forceinline__ void complex_matmul_load_b_truncated(
    ...
    wmma::fragment<wmma::matrix_a, WMMA_M, WMMA_K, WMMA_N, wmma_half_t, ALayout> a_frag[MATMUL_WARP_WIDTH][MATMUL_WARP_WIDTH][2],
    wmma::fragment<wmma::accumulator, WMMA_M, WMMA_K, WMMA_N, wmma_half_t> acc_frag_1[MATMUL_WARP_WIDTH][MATMUL_WARP_WIDTH][2],
    wmma::fragment<wmma::matrix_b, WMMA_M, WMMA_K, WMMA_N, wmma_half_t, BLayout> k_frag[MATMUL_WARP_WIDTH][MATMUL_WARP_WIDTH][2],
    wmma::layout_t out_layout = wmma::mem_row_major)
{
   wmma::fragment<wmma::matrix_b, WMMA_M, WMMA_K, WMMA_N, wmma_half_t, BLayout> b_frag[MATMUL_WARP_WIDTH][MATMUL_WARP_WIDTH][2];
