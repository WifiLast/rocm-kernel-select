...
#include "kernels_fp16/monarch_cuda_16_16_16_complex_kernel.h"
#include "kernels_fp16/monarch_cuda_32_16_16_complex_kernel.h"
#include "kernels_fp16/monarch_cuda_16_32_32_complex_kernel.h"
...
#define CHECK_LAST_CUDA_ERROR() checkLastComplexFP16Fwd(__FILE__, __LINE__)
void checkLastComplexFP16Fwd(const char* const file, const int line)
{
...
monarch_conv_cuda_16_16_16_complex(
  torch::Tensor x_real,
  torch::Tensor x_imag,
  torch::Tensor k_f,
    ...
    case 4096:
      ...
      if (B >= 4 && (B % 4) == 0 && (H % 8) == 0) {
        ...
        monarch_conv_cuda_complex_kernel<32, 4, 4096, 1, 16, false, 4, 8, 4><<<gridDim, blockDim, (2 * fftsize + 4 * 256) * sizeof(half)>>>(
            ...
            static_cast<at::Half *>(out_real.data_ptr()),
            static_cast<at::Half *>(out_imag.data_ptr()),
            B,
            H,
            N,
            16);
...
std::pair<torch::Tensor, torch::Tensor>
monarch_conv_cuda_32_16_16_complex(
  torch::Tensor x_real,
  torch::Tensor x_imag,
  torch::Tensor k_f,
  ...
  switch (fftsize) {
    case 8192:
      ...
      if (B >= 8 && (B % 8) == 0 && (H % 8) == 0) {
        ...
        monarch_conv_cuda_complex_kernel<32, 8, 8192, 2, 1, 16, false, 8, 8, 8><<<gridDim, blockDim, (2 * fftsize + 4 * 1024) * sizeof(half)>>>(
            static_cast<at::Half *>(x_real.data_ptr()),
            static_cast<at::Half *>(x_imag.data_ptr()),
            static_cast<complex_half_t *>(k_f.data_ptr()),
...
std::pair<torch::Tensor, torch::Tensor>
monarch_conv_cuda_16_32_32_complex(
  torch::Tensor x_real,
  torch::Tensor x_imag,
  torch::Tensor k_f,
  torch::Tensor f_16_fft,
...
std::pair<torch::Tensor, torch::Tensor>
monarch_conv_cuda_32_32_32_complex(
  torch::Tensor x_real,
  torch::Tensor x_imag,
  torch::Tensor k_f,
  torch::Tensor f_32_fft,
...
std::pair<torch::Tensor, torch::Tensor>
monarch_conv_cuda_32_32_32_complex_truncated(
  torch::Tensor x_real,
  torch::Tensor x_imag,
  torch::Tensor k_f,
  torch::Tensor f_32_fft,
  ...
  switch (fftsize) {
    case 32768:
      if (B >= 2 && (B % 2) == 0 && (H % 8) == 0) {
        ...
        CUDA_RT_CALL(cudaFuncSetAttribute(&monarch_conv_cuda_32_32_32_complex_kernel_truncated<32, 8, 32768, 2, 16, false, 2, 8, 8>, cudaFuncAttributeMaxDynamicSharedMemorySize, 135168));

        monarch_conv_cuda_32_32_32_complex_kernel_truncated<32, 8, 32768, 2, 16, false, 2, 8, 8><<<gridDim, blockDim, (2 * fftsize) * sizeof(half)>>>(
            static_cast<at::Half *>(x_real.data_ptr()),
            static_cast<at::Half *>(x_imag.data_ptr()),
            static_cast<complex_half_t *>(k_f.data_ptr()),
            static_cast<complex_half_t *>(f_32_fft.data_ptr()),
        ...
        CUDA_RT_CALL(cudaFuncSetAttribute(&monarch_conv_cuda_32_32_32_complex_kernel_truncated<32, 8, 32768, 2, 16, false, 1, 8, 8>, cudaFuncAttributeMaxDynamicSharedMemorySize, 135168));

        monarch_conv_cuda_32_32_32_complex_kernel_truncated<32, 8, 32768, 2, 16, false, 1, 8, 8><<<gridDim, blockDim, (2 * fftsize) * sizeof(half)>>>(
            static_cast<at::Half *>(x_real.data_ptr()),
            static_cast<at::Half *>(x_imag.data_ptr()),
            static_cast<complex_half_t *>(k_f.data_ptr()),
            static_cast<complex_half_t *>(f_32_fft.data_ptr()),
        ...
        CUDA_RT_CALL(cudaFuncSetAttribute(&monarch_conv_cuda_32_32_32_complex_kernel_truncated<32, 8, 32768, 2, 16, false, 1, 1, 8>, cudaFuncAttributeMaxDynamicSharedMemorySize, 135168));

        monarch_conv_cuda_32_32_32_complex_kernel_truncated<32, 8, 32768, 2, 16, false, 1, 1, 8><<<gridDim, blockDim, (2 * fftsize) * sizeof(half)>>>(
            static_cast<at::Half *>(x_real.data_ptr()),
            static_cast<at::Half *>(x_imag.data_ptr()),
            static_cast<complex_half_t *>(k_f.data_ptr()),
            static_cast<complex_half_t *>(f_32_fft.data_ptr()),
