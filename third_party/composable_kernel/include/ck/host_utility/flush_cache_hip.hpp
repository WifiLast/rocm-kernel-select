...
inline void flush_icache()
{
   ...
   hipLaunchKernelGGL(( ck::flush_icache), dim3(dim3(gpu_block3)), dim3(dim3(64)), 0, nullptr, );
...
#define MEDIAN 0
    if(stream_config.time_kernel_)
    {
        ...
        {
           hipLaunchKernelGGL(( kernel), dim3(grid_dim), dim3(block_dim), lds_byte, stream_config.stream_id_, gemm_args, args...);
            hip_check_error(hipGetLastError());
        }
