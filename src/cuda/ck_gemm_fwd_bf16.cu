// CK WMMA GEMM instantiation: plain (no bias), ck::bhalf_t.
...
int ck_gemm_count_bf16() { return detail::count_plain<ck::bhalf_t>(); }

bool ck_gemm_entry_bf16(int idx, int action, const GemmProblem& p, const void* p_a,
    ...
    return detail::entry_plain<ck::bhalf_t>(idx, static_cast<detail::Action>(action), p, p_a, p_b,
