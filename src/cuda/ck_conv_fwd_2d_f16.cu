// CK WMMA grouped-conv-forward instantiation: 2D, ck::half_t.
...
int ck_count_2d_f16() { return detail::count<2, ck::half_t>(); }

bool ck_entry_2d_f16(int idx, int action, const ConvProblem& p, const void* p_in,
                      const void* p_wei, const void* p_bias, void* p_out,
                      void* p_ws, size_t* out_ws, hipStream_t stream) {
    return detail::entry<2, ck::half_t>(idx, static_cast<detail::Action>(action), p,
