// CK WMMA grouped-conv-forward instantiation: 3D, ck::bhalf_t.
...
int ck_count_3d_bf16() { return detail::count<3, ck::bhalf_t>(); }

bool ck_entry_3d_bf16(int idx, int action, const ConvProblem& p, const void* p_in,
                      const void* p_wei, const void* p_bias, void* p_out,
                      void* p_ws, size_t* out_ws, hipStream_t stream) {
    return detail::entry<3, ck::bhalf_t>(idx, static_cast<detail::Action>(action), p,
