// CK WMMA GEMM instantiation: bias + detail::Add, ck::bhalf_t.
...
int ck_gemm_count_add_bf16() { return detail::count_fused<ck::bhalf_t, detail::Add>(); }

bool ck_gemm_entry_add_bf16(int idx, int action, const GemmProblem& p, const void* p_a,
    ...
    return detail::entry_fused<ck::bhalf_t, detail::Add>(idx, static_cast<detail::Action>(action), p, p_a,
