// CK WMMA GEMM instantiation: bias + detail::AddSilu, ck::bhalf_t.
...
int ck_gemm_count_silu_bf16() { return detail::count_fused<ck::bhalf_t, detail::AddSilu>(); }

bool ck_gemm_entry_silu_bf16(int idx, int action, const GemmProblem& p, const void* p_a,
    ...
    return detail::entry_fused<ck::bhalf_t, detail::AddSilu>(idx, static_cast<detail::Action>(action), p, p_a,
