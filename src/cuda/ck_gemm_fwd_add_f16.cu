// CK WMMA GEMM instantiation: bias + detail::Add, ck::half_t.
...
int ck_gemm_count_add_f16() { return detail::count_fused<ck::half_t, detail::Add>(); }

bool ck_gemm_entry_add_f16(int idx, int action, const GemmProblem& p, const void* p_a,
    ...
    return detail::entry_fused<ck::half_t, detail::Add>(idx, static_cast<detail::Action>(action), p, p_a,
